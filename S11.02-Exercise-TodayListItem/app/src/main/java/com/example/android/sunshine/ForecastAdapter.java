...
//  COMPLETED (6) Declare constant IDs for the ViewType for today and for a future day
    private static final int VIEW_TYPE_TODAY = 10;
    private static final int VIEW_TYPE_FUTURE_DAY = 20;
...
//      COMPLETED (14) Otherwise, throw an IllegalArgumentException
        else throw new IllegalArgumentException("Invalid view type, value of " + viewType);
...
//      COMPLETED (17) Otherwise, throw an IllegalArgumentException
        else throw new IllegalArgumentException("Invalid view type, value of " + itemViewType);
